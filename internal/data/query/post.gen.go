...
func newPost(db *gorm.DB, opts ...gen.DOOption) post {
	...
	_post.DeleteAt = field.NewInt32(tableName, "delete_at")
	...
	_post.ThumbNum = field.NewInt32(tableName, "thumb_num")
	_post.FavourNum = field.NewInt32(tableName, "favour_num")
...
func (p *post) updateTableName(table string) *post {
	...
	p.DeleteAt = field.NewInt32(table, "delete_at")
	p.Title = field.NewString(table, "title")
	p.Content = field.NewString(table, "content")
	p.Tags = field.NewString(table, "tags")
	p.ThumbNum = field.NewInt32(table, "thumb_num")
	p.FavourNum = field.NewInt32(table, "favour_num")
...
func (p *post) fillFieldMap() {
	...
	p.fieldMap["delete_at"] = p.DeleteAt
	p.fieldMap["title"] = p.Title
	p.fieldMap["content"] = p.Content
	p.fieldMap["tags"] = p.Tags
	p.fieldMap["thumb_num"] = p.ThumbNum
	p.fieldMap["favour_num"] = p.FavourNum
